...
- If **no** character reference, do NOT invent specific appearance details (age, ethnicity, body, hair, skin) — just keep **one consistent look** across every shot (same person, same hair, same face) so she does NOT change scene to scene.
